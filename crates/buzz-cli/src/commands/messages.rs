...
mod tests {
    use super::{
        channel_id_from_event, cmd_get_thread, effective_media_source, event_mention_pubkeys,
        extract_imeta_tags, find_root_from_tags, match_profiles_by_name, merge_message_mentions,
